...
function Report() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'total_cost',
      width: 120,
      render: (value) => `Ã¢â€šÂ¹${value?.toFixed(2) || '0'}`,
      onHeaderCell: () => ({
        style: tableStyles.header,
      }),
    },
              ...
              {loading ? (
                ...
                <>
                    ...
                    summary={(pageData) => {
                      ...
                      return (
                        <Table.Summary.Row style={tableStyles.summary}>
                          ...
                          <Table.Summary.Cell>Ã¢â€šÂ¹{(totals.total_cost || 0).toFixed(2)}</Table.Summary.Cell>
                        </Table.Summary.Row>
                      );
                    }}
                  />
                  ...
                  <div className="mt-4 text-right text-blue-800">
                    ...
                    <Text strong className="ml-8">Total Cost: Ã¢â€šÂ¹{shiftData?.reduce((acc, curr) => acc + (Number(curr.total_cost) || 0), 0).toFixed(2)}</Text>
                  </div>
                </>
              )}
            </div>
